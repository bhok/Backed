...
const string strMessageMagic = "Backed Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    // proof of stake rewards. POS begins at block 1001
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Backed", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Backed";
        CTransaction txNew;
        txNew.nTime = 1435099584;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1435099584;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 14858217;
       ...
       if (false && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("0x4b938ecf2116e8416d8b9a9a446cb22749515347daf4401ce0e17849dbb357cb"));
    ...
    string strPubKey = "045dd980779a829433e8e96c7b657fe7077712a42e5c4fd6378bb184cec1a6681b85e1b78f6be7c88a3395cfed72a3b969e865fa7acf66f66f96b8cb7934a635df";
...
unsigned char pchMessageStart[4] = { 0xb7, 0xb7, 0xf7, 0xb7 };
